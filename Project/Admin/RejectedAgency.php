...
if(isset($_GET["rid"]))
{
  $delQry="update tbl_agent set agent_vstatus=1 where agent_id='".$_GET["rid"]."'";
  $con->query($delQry);
  header("Location:RejectedAgency.php");
}
?>
...
?>
<br /><br /><br />
<form id="form1" name="form1" method="post" action="AcceptedAgency.php">
  <table border="1"align="center" cellpadding="10" style="border-collapse:collapse">
    ...
    $sel="select * from tbl_agent where agent_vstatus=2";
	$row=$con->query($sel);
	$i=0;
  ...
  <tr>
      ...
      <td><a href="RejectedAgency.php?rid=<?php echo $data["agent_id"];?>">Accept</a></td>
